...
### Planned Features
 ...
 - [ ] Needs to be able to trade crypto (Hopefully Stock as well in the future) automaticly depending on the data collected.
 - [ ] Using the matrix algebra I want to train Models using linear regression with the LSE method and Gradient Descent.
 - [ ] I want it to be able to use backtesting using strategies and or trained models.
